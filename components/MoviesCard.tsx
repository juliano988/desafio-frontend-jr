...
export default function MoviesCard(props: { charImg: string, charName: string, charDescription: string, charAppearances: JSX.Element, fansRate: number }): JSX.Element {
